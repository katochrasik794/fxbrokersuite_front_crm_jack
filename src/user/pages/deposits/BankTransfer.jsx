      ...
      <div className="bg-gray-50 min-h-screen p-4 sm:p-6">
        ...
        <div className="flex justify-center"  >
          <button
            ...
            className="max-w-4xl w-full bg-blue-600 text-dark-base py-4 rounded-lg flex items-center justify-center hover:bg-blue-700 transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          >
