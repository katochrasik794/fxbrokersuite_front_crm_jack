      ...
      <div className="rounded-2xl overflow-hidden bg-white shadow-sm border border-gray-200">
        ...
        <div className="border-b border-gray-200 bg-gray-50 px-4 py-2">
          <div className="flex flex-col lg:flex-row gap-2 items-center">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {filters?.dateKey && (
                <div className="flex items-center gap-0 border border-gray-300 bg-white rounded-lg h-[40px] px-2 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition-all">
                  ...
                  <input
                    ...
                    className="bg-transparent border-none px-1 py-1 text-sm outline-none w-[120px] cursor-pointer"
                    title="From Date"
                  />
            ...
            <div className="flex gap-1">
              ...
              <button
                onClick={clearDates}
                className="rounded-lg border border-gray-300 bg-white px-3 py-2 h-[40px] text-xs hover:bg-gray-50 transition-all font-semibold text-gray-700 whitespace-nowrap"
                title="Clear date filters"
              >
                Clear
              </button>
              <button onClick={resetAll}
                className="rounded-lg bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 h-[40px] text-xs shadow-sm hover:shadow transition-all font-semibold whitespace-nowrap">
                Reset
              </button>
              <div className="w-[1px] h-6 bg-gray-300 mx-1 self-center" />
              {/* Download Buttons */}
              <button onClick={exportToPDF}
                className="rounded-lg border border-gray-300 bg-white px-3 py-2 h-[40px] text-xs hover:bg-gray-50 transition-all font-medium flex items-center gap-1.5 whitespace-nowrap text-gray-700">
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-t border-gray-200">
          ...
          <div className="flex gap-2">
            ...
            <span className="rounded-lg border border-gray-300 bg-blue-600 text-dark-base px-4 py-2 text-sm font-medium">
              {page}
            </span>
